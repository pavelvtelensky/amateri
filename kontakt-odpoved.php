...
<head>
	...
	<script type="text/javascript" src="assets/js/plugins/sliders/slider_pips.min.js"></script>
...
<body>
	...
	<?php include ("app/kontakt-odpoved/navbar.php"); ?>
	...
	<div class="page-container">
		...
		<div class="page-content">
			<?php include ("app/kontakt-odpoved/menu.php"); ?>
			<?php include ("app/kontakt-odpoved/content.php"); ?>
		</div>
		<!-- /page content -->
