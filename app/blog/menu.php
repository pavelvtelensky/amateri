...
<!-- Moje menu -->
								<li class="navigation-header"><span>Moje menu</span> <i class="icon-menu" title="Main pages"></i></li>
								<li>
									<a href="seznamka.php"><i class="icon-stack2"></i> <span>Seznamka</span></a>
									<ul>
										<li><a href="./">Výpis seznamka</a></li>
									</ul>
								</li>								
								<li>
									<a href="blog.php"><i class="icon-stack2"></i> <span>Blog</span></a>
									<a href="povidky.php"><i class="icon-stack2"></i> <span>Povídky</span></a>
									<a href="magazin.php"><i class="icon-stack2"></i> <span>Magazín</span></a>
									<a href="komentare.php"><i class="icon-stack2"></i> <span>Komentáře</span></a>
								</li>
<!-- /Moje menu -->
								<!-- Main -->
